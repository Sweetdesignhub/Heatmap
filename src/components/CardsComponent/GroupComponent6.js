...
const GroupComponent6 = () => {
  return (
    <div className={styles.div}>
        <div className={styles.div2}>Performance Reporting Dashboard</div>
        <img
          loading="lazy"
        ...
        <div className={styles.div15}>
          <div className={styles.div16}>
            ...
            <div className={styles.div18}>01</div>
            <div className={styles.div19b}>0</div>
        ...
        <div className={styles.div27}>
          <div className={styles.div28}>
            ...
            <div className={styles.div30}>01</div>
            <div className={styles.div31b}>0</div>
        ...
        <div className={styles.div39}>
          <div className={styles.div40}>
            ...
            <div className={styles.div41a}>00</div>
          </div>
        </div>
        <img
          loading="lazy"
        ...
        <div className={styles.div42}>
          ...
          <div className={styles.div46c}>00</div>
        </div>
      </div>
  );
}
