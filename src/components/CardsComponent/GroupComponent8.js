...
const GroupComponent8 = () => {
  return (
    <div className={styles.div}>
        <div className={styles.div2}>general Asset Account</div>
        <img
          loading="lazy"
        ...
        <div className={styles.div27}>
          <div className={styles.div28}>
            ...
            <div className={styles.div30}>02</div>
        ...
        <div className={styles.div39}>
          <div className={styles.div40}>
            ...
            <div className={styles.div41a}>01</div>
          </div>
        </div>
        <img
          loading="lazy"
